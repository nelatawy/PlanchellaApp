...
public class User {
    ...
    public void updateByDelta(User newUserData){
        if(newUserData != null) {
            if (newUserData.getName() != null) this.setName(newUserData.getName());
            if (newUserData.getPicUrl() != null) this.setPicUrl(newUserData.getPicUrl());
            if (newUserData.getAccountUrl() != null) this.setAccountUrl(newUserData.getAccountUrl());
        }
